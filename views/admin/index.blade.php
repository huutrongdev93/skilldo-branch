    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! form()->select2('branchStatus', \BranchManagement\Enums\BranchStatus::options()->pluck('label', 'value')->toArray(), [
                    'label' => 'Trạng thái'
                ])->html() !!}
            </div>
    ...
    $(function() {
        ...
        class BranchIndex
        {
            ...
            clickSaveStatus(element) {
                ...
                let data = {
                    action: 'BranchManagement\\Ajax\\Admin\\BranchAjax::status',
            ...
            clickDefault(element) {
                ...
                let data = {
                    action: 'BranchManagement\\Ajax\\Admin\\BranchAjax::default',
                    id: id
                }
